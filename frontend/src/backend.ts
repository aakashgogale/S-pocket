...
import type { ExternalBlob as _ExternalBlob, FileRecord as _FileRecord, RiskLevel as _RiskLevel, Timestamp as _Timestamp, UserId as _UserId, UserProfile as _UserProfile, UserRole as _UserRole, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async adminGetAllActivityLogs(): Promise<Array<ActivityLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminGetAllActivityLogs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminListAllFiles(): Promise<Array<FileRecord>> {
        if (this.processError) {
            try {
    ...
    async adminListUsers(): Promise<Array<[Principal, UserProfile]>> {
        if (this.processError) {
            try {
    ...
    async getFile(arg0: string): Promise<FileRecord | null> {
        if (this.processError) {
            try {
    ...
    async getMyActivityLogs(): Promise<Array<ActivityLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyActivityLogs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listMyFiles(): Promise<Array<FileRecord>> {
        if (this.processError) {
            try {
    ...
    async uploadFile(arg0: string, arg1: bigint, arg2: string, arg3: ExternalBlob): Promise<FileRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFile(arg0, arg1, arg2, await to_candid_ExternalBlob_n20(this._uploadFile, this._downloadFile, arg3));
...
function from_candid_RiskLevel_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RiskLevel): RiskLevel {
...
async function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FileRecord]): Promise<FileRecord | null> {
    return value.length === 0 ? null : await from_candid_FileRecord_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        riskLevel: from_candid_RiskLevel_n14(_uploadFile, _downloadFile, value.riskLevel)
    };
}
